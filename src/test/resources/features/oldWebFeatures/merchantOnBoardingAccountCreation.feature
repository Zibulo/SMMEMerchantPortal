...
Feature: Creating a new merchant personal account after application
  ...
  Scenario Outline: "<ScenarioDescription>"
    ...
    Examples:
      ...
      | 1  | SMME valid credential login | Positive     | SMME Merchant Login |  | smmeAccoutCreation | Itumeleng Phale |                    | VPS983577986487 | 143@Mayoga | Business owner/director | Ecomm Automator | VFS Ecomm | Itumeleng.Phale@vodacom.co.za | 0829973883 | Passport | 0104041074089 | 4586 Isacholo Crescent | 0157               | Amberville     | Centurion    | Gauteng  |
