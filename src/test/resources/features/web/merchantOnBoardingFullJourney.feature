@merchantOnBoardingFullJenourney
...
Feature: OnBoarding New Merchant Choose POS Option
  ...
  Scenario Outline: "<ScenarioDescription>"
    ...
    And I take a selfie
    And I  upload documents "<companyTypeOption>"
      #And I tell about partners
    #And I logoff from Merchant Portal


    Examples:
      | TC | ScenarioDescription               | ScenarioType | reportName          |  | landingPage | reportAuthor       | landingPageSuccess | deviceOption | merchantId      | passWord   | ownershipDetails        | firstName       | surName   | eMail                                | mobileNo   | idType        | idNo          | businessStreetName     | businessPostalCode | businessSuburb | businessTown | Province | companyTypeOption | monthlyIncomeKnowledge | businessMonthlIncome | companyRegName  | companyDifferentName | companyTradingName        | companyRegNo | businessCategory          | partnersID    | accountName | accountNumber |
      | 1  | Merchant onBoard Chop-Chop Device | Positive     | SMME Merchant Login |  | smmeURL     | Livhuwani Mutshafa |                    | Chop-Chop    | VPS983577986487 | 143@Mayoga | Business owner/director | Ecomm Automator | VFS Ecomm | livhuwani.mutshafa@vcontractor.co.za | 0829973883 | South African | 0104041074089 | 4586 Isacholo Crescent | 0157               | Amberville     | Centurion    | Gauteng  | Sole Proprietorship           | No                     | 150000               | IBP Testing VFS | Yes                  | Ditekong Software Testing | 123456789012 | Agricultural Cooperatives | 6508267473086 | TM Ngwane   | 1234567890    |
