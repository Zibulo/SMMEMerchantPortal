...
Feature: Device Activation
  ...
  Scenario Outline: "<ScenarioDescription>"
   ...
   # And Access Device Activation Page
    ...
    And I take a selfie
    And Submit business details "<ownershipDetails>" "<title>" "<idNo>" "<companyRegName>" "<businessCategory>" "<inputBusinessStreetName>" "<businessAdress>"
